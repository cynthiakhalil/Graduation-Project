...
public class SampleUtils
{
    ...
    public static boolean checkGLError(String op)
    {
        ...
        for (int errorCode = GLES20.glGetError(); errorCode != 0; errorCode = GLES20.glGetError())
        {
            success = false;
            Log.e(LOGTAG, "After operation " + op + " got glError 0x" + Integer.toHexString(errorCode));
        }
